        ...
        <div className="w-full max-w-2xl p-8 rounded-lg shadow-lg flex flex-row items-start space-x-32">
            ...
            <div className="flex flex-col items-start">
                ...
                <ul className="list-none list-inside mt-20">
                  ...
                  <li className="text-black mb-4 text-left flex items-cente">
                  <Image src="/uva.png" alt="icon" width={30} 
                        height={30} className="w-4 h-4 mr-2"/>
                  {product?.type}</li>
                  <li className="text-black mb-4 text-left flex items-center">
                    <Image src="/bodega.png" alt="icon" width={30} 
                        height={30} className="w-4 h-4 mr-2"/>
                    {product?.store}</li>
